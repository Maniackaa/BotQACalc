...
questions = {
    ...
    15: {'q': 'Введите кол-во перемычек', 'a': [], 'check_func': float, 'variable_answer': True,},
    ...
    19: {'q': 'Введите кол-во подпятников', 'a': ['1'], 'check_func': float, 'variable_answer': True},
    ...
    30: {'q': 'Введите количество комплектов окантовки', 'a': [], 'variable_answer': True, 'check_func': float},
